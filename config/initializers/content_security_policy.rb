...
Rails.application.config.content_security_policy do |p|
  ...
  p.font_src        :self, assets_host, "https://fonts.googleapis.com", "https://fonts.gstatic.com", "https://use.typekit.net", "https://p.typekit.net"
  p.img_src         :self, :data, :blob, *media_hosts
  p.style_src       :self, assets_host, "https://fonts.googleapis.com", "https://fonts.gstatic.com", "https://use.typekit.net", "https://p.typekit.net"
